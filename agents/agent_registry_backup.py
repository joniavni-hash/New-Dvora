#!/usr/bin/env python3
"""
Agent Registry - OpenClaw Agent Management
    ...
    def __init__(self):
        self.agents = {
            ...
            'tzofit': {
                ...
                'script': 'agents/tzofit/tzofit_agent.py',
                'description': 'חוקרת - מחקר שוק, תחרותי, מודיעין עסקי'
            },
            'dana': {
                'name': 'דנה - Fitness Agent',
                'domain': 'fitness',
                'skills': ['fitness-tracking', 'nutrition'],
                'script': 'agents/dana/dana_agent.py', 
                'description': 'מאמנת כושר - מעקב תזונה, יעדים, תכנון'
            },
            'audya': {
                'name': 'אודיה - Group Communication Agent',
                'domain': 'groups',
                'skills': ['whatsapp-groups', 'communication'],
                'script': 'agents/audya/audya_agent.py',
                'description': 'מתאמת קבוצות - WhatsApp, תקשורת, סיכומים'
            }
        }
